...
def second_task():
    ...
    in_both_eskymo_prepos = set(eskymo) & set(prepos)   # vase reseni
    # test
...
def fourth_task():
    ...
    backward_except_last = ''.join(reversed(udubutubudu[:-1]))  # vase reseni
    # test
...
def fifth_task():
    ...
    hymn_list = str.split(hymn_st_john)  # vase reseni
